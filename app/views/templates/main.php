...
<head>
    ...
    <?= $title == 'TomTroc - Home' ? '<link rel="stylesheet" href="/P4-TomTroc/public/css/home.css">' : ($title == 'TomTroc - Login' || $title == 'TomTroc - Register' ? '<link rel="stylesheet" href="/P4-TomTroc/public/css/login.css">' : '') ?>
</head>
